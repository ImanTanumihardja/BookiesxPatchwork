...
class OverrideFuncGen {
    gen(schema) {
        ...
        if (features.some((feature) => feature === contractSchema_1.Feature.PATCH) && features.some((feature) => feature === contractSchema_1.Feature.FRAGMENTSINGLE)) {
            out += `\n`;
        ...
        if (features.includes(contractSchema_1.Feature.WEAKREF)) {
            out += `\n`;
            out += `/**\n`;
        ...
        return (0, generator_1.ind)(4, `${out}`);
    }
}
exports.OverrideFuncGen = OverrideFuncGen;
