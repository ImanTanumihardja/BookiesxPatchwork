...
exports.FieldFuncGen = void 0;
const generator_1 = require("../generator");
const utils_1 = require("../utils");
class FieldFuncGen {
    gen(schema) {
        function generateLoadStoreFunctions(fields) {
            ...
            for (let field of fields) {
                ...
                let capName = (0, utils_1.cleanAndCapitalizeFirstLetter)(field.key);
                ...
                if (field.arrayLength > 1) {
                    ...
                    const storeFunction = `` +
                        ...
                        `${(0, generator_1.ind)(4, permissionLine)}\n` +
        ...
        return (0, generator_1.ind)(4, `${loadStoreFunctions}`);
    }
}
exports.FieldFuncGen = FieldFuncGen;
