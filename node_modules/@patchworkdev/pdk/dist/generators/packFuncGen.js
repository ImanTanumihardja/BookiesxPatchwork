...
class PackFuncGen {
    gen(schema) {
        ...
        function generateUnpackMetadataFunction(entries) {
            let slotIndex = 0;
            let unpackLines = [];
            function unpackField(field, arrayIdx) {
                if (field.arrayLength === 0) {
                    return;
                }
